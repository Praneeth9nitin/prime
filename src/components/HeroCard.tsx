...
function HeroCard() {
  ...
  return (
    <div className="" >
      ...
      <div className="md:flex items-center md:justify-center gap-y-5 lg:gap-10 md:gap-4 grid grid-cols-2 text-white">
      {cards.map((card,index)=>
      <div key={index} className=""  onClick={()=>nav(card.link)}>
        <div className="bg-card shadow-md shadow-card card flex flex-col cursor-pointer items-center text-center justify-self-center justify-center gap-5 h-52 md:p-4 w-44 p-4 lg:w-54 xl:w-64 rounded-xl">
