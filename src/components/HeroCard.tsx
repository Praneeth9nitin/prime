  ...
  return (
    <div className="" >
      ...
      <div key={index}  onClick={()=>nav(card.link)}>
        <div className="bg-card shadow-md shadow-card card flex flex-col cursor-pointer items-center text-center justify-self-center justify-center gap-5 h-52 md:p-4 w-44 p-4 md:w-64 rounded-xl">
