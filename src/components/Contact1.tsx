...
function Contact1() {
    return (
        <div className="flex w-96 sm:w-2/3 md:w-screen md:flex-row flex-col justify-center md:pb-11 xl:px-32 gap-8 items-center font-josefin h-full">
            ...
            <iframe
                ...
                loading="lazy"
                className="rounded shadow border-4 md:h-190 mx-10 md:mx-2 mb-5 md:mb-0 border-slate-300 w-80 md:w-1/2"
