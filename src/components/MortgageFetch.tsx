...
function MortgageFetch() {
  return (
    <div className="md:flex w-screen text-center md:justify-center">
    {title.map((item,index)=>
      <div key={index} className="flex flex-col gap-3">
        <div className="text-2xl font-bold">{item}</div>
        <div className="grid grid-cols-2 gap-8 sm:gap-4 xl:gap-8 shadow-2xl p-4 sm:p-2 m-3 xl:px-16 rounded-2xl bg-white" >
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-4 xl:gap-8 shadow-2xl m-3 sm:p-2 xl:px-11 bg-white p-4 rounded-2xl" >
