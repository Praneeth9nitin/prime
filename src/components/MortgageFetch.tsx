  ...
  return (
    ...
    {loanOption.map((item,index)=>
      <div key={index}>
        ...
        <div className="grid grid-cols-2 gap-8 shadow-2xl p-3 px-6 md:p-6 md:px-24 m-3 rounded-2xl bg-white" >
        ...
        <div className="grid grid-cols-2 gap-8 shadow-2xl p-3 bg-white px-6 md:p-6 md:px-24 m-3 rounded-2xl" >
