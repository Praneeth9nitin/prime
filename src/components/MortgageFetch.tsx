  ...
  return (
    ...
    {title.map((item,index)=>
      <div key={index}>
        ...
        <div className="grid grid-cols-2 gap-8 shadow-2xl p-3 px-6 md:p-12 xl:p-6 xl:px-16 m-3 rounded-2xl bg-white" >
        ...
        <div className="grid grid-cols-2 gap-8 shadow-2xl p-3 bg-white px-6 md:p-12 xl:p-6 xl:px-16 m-3 rounded-2xl" >
