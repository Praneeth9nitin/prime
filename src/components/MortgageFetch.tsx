  ...
  return (
    ...
    {loanOption.map((item,index)=>
      <div key={index}>
        ...
        <div className="grid grid-cols-2 shadow-2xl p-3 px-6 md:p-6 md:px-24 m-3 rounded-2xl" >
            <div className="col-span-2 text-xs text-center">PURCHASE - 30 YEAR FIXED</div>
        ...
        <div className="grid grid-cols-2 shadow-2xl p-3 px-6 md:p-6 md:px-24 rounded-2xl" >
