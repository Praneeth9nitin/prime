                ...
                <div className='xl:mx-28 bg-white'>
                    <div className="container bg-white font-sans mx-auto mt-12 mb-12 px-4 md:px-8 lg:px-12 py-8">
                        ...
                        <div className="text-xl text-gray-700 leading-relaxed font-opensans">
                            ...
                            <p>If you have consented to receive text messages from Prime Insurance Services, you may receive messages related to the following:</p>
                            ...
                            <p>Example: "Hello, this is a friendly reminder of your upcoming appointment with Dr. [Name] at [Location] on [Date] at [Time]. You can reply STOP to opt out of SMS messaging from Prime Insurance Services at any time."</p>

                            <h2 className="font-semibold mt-4">Message Frequency</h2>
                            <p>Message frequency may vary depending on the type of communication. For example, you may receive up to 2 SMS messages per week related to your inquiries.</p>
                            ...
                            <p>You may opt-in to receive SMS messages from Prime Insurance Services in the following ways:</p>
                            <ul className="list-disc ml-6">
                            ...
                            <p>If you are experiencing any issues, you can reply with the keyword "HELP" or contact us directly at 980-297-9827.</p>
